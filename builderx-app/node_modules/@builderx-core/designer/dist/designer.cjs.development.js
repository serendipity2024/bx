...
var yogax = require('@builderx-core/yogax');
...
var conversions = require('@builderx-core/conversions');
var EntypoIcon = _interopDefault(require('react-native-vector-icons/dist/Entypo'));
var AntDesignIcon = _interopDefault(require('react-native-vector-icons/dist/AntDesign'));
var EvilIconsIcon = _interopDefault(require('react-native-vector-icons/dist/EvilIcons'));
var FeatherIcon = _interopDefault(require('react-native-vector-icons/dist/Feather'));
var FontAwesomeIcon = _interopDefault(require('react-native-vector-icons/dist/FontAwesome'));
var FoundationIcon = _interopDefault(require('react-native-vector-icons/dist/Foundation'));
var IoniconsIcon = _interopDefault(require('react-native-vector-icons/dist/Ionicons'));
var MaterialCommunityIconsIcon = _interopDefault(require('react-native-vector-icons/dist/MaterialCommunityIcons'));
var MaterialIconsIcon = _interopDefault(require('react-native-vector-icons/dist/MaterialIcons'));
var OcticonsIcon = _interopDefault(require('react-native-vector-icons/dist/Octicons'));
var SimpleLineIconsIcon = _interopDefault(require('react-native-vector-icons/dist/SimpleLineIcons'));
var ZocialIcon = _interopDefault(require('react-native-vector-icons/dist/Zocial'));
var EntypoFont = _interopDefault(require('react-native-vector-icons/Fonts/Entypo.ttf'));
var AntDesignFont = _interopDefault(require('react-native-vector-icons/Fonts/AntDesign.ttf'));
var EvilIconsFont = _interopDefault(require('react-native-vector-icons/Fonts/EvilIcons.ttf'));
var FeatherFont = _interopDefault(require('react-native-vector-icons/Fonts/Feather.ttf'));
var FontAwesomeFont = _interopDefault(require('react-native-vector-icons/Fonts/FontAwesome.ttf'));
var FoundationFont = _interopDefault(require('react-native-vector-icons/Fonts/Foundation.ttf'));
var IoniconsFont = _interopDefault(require('react-native-vector-icons/Fonts/Ionicons.ttf'));
var MaterialCommunityIconsFont = _interopDefault(require('react-native-vector-icons/Fonts/MaterialCommunityIcons.ttf'));
var MaterialIconsFont = _interopDefault(require('react-native-vector-icons/Fonts/MaterialIcons.ttf'));
var OcticonsFont = _interopDefault(require('react-native-vector-icons/Fonts/Octicons.ttf'));
var SimpleLineIconsFont = _interopDefault(require('react-native-vector-icons/Fonts/SimpleLineIcons.ttf'));
var ZocialFont = _interopDefault(require('react-native-vector-icons/Fonts/Zocial.ttf'));
var styled = require('styled-components');
var styled__default = _interopDefault(styled);
var get = _interopDefault(require('lodash/get'));
var builderxModuleContextMenu = require('builderx-module-context-menu');
require('builderx-module-context-menu/src/lib/components/utils/ContextMenu.css');
var draftJs = require('draft-js');
var paper = _interopDefault(require('paper'));
var LineSegmentSliderInput = _interopDefault(require('line-segment-slider-input'));
...
var RootRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(TheChosenOne, {
...
var DesignerReact = /*#__PURE__*/function (_React$PureComponent2) {
  ...
  function DesignerReact() {
    ...
    _this3.showConstructionLines = function () {
      ...
      if (_this3.renderCompiledDom) {
        var pane = ReactDOM.findDOMNode(_this3.renderCompiledDom);
  ...
  _proto2.render = function render() {
    ...
    }, React.createElement(ZoomContainer, {
      canvas: canvas,
      style: {
...
function () {
  var Serializable = /*#__PURE__*/function () {
    ...
    Serializable.fromJS = function fromJS(snapshot, classObject) {
      ...
      _.forEach(Object.keys(snapshot), function (key) {
        ...
        if (_.isNil(snapshot[key])) {
          ...
          if (_.isArray(snapshot[key])) {
            ...
            _.forEach(snapshot[key], function (element) {
          ...
          _.forEach(snapshot[key], function (value, mapKey) {
    ...
    _proto.toJS = function toJS(shallow) {
      ...
      _.forEach(fields, function (value, key) {
        ...
        if (value) {
          if (value.type === 'array') {
            if (_.isArray(_this2[key])) {
              ret[key] = [];

              _.forEach(_this2[key], function (element) {
                if (_.isArray(element) && value.children.type === 'array') {
                  console.log('case not handled -!-!- toJS Serializable');
                } else if (typeof element === 'object') {
...
var Model = /*#__PURE__*/function (_Serializable) {
  ...
  _proto.on = function on(properties, listener) {
    ...
    if (arrayOfProperties) {
      ...
      this.reverseMap.set(listener, _.uniq(arrayOfProperties));
    } else {
  ...
  _proto.emit = function emit(properties) {
    ...
    var combinedArrayOfListeners = _.reduce(properties, function (combined, property) {
      var existingArrOfListeners = _this3.eventListenersMap.get(property);

      if (existingArrOfListeners) {
        combined = _.union(combined, existingArrOfListeners);
      }
        ...
        if (actionCounter) {
          ...
          if (existingUpdateObject) {
            ...
            pendingUpdates.set(listener, {
              properties: _.uniq(existingUpdateObject.properties),
              model: _this3
            });
          } else {
            pendingUpdates.set(listener, {
    ...
    properties.forEach(function () {
      ...
      if (arrayOfProperties) {
        arrayOfProperties.forEach(function (key) {
          ...
          _.remove(existingArrOfListeners, function (n) {
            return n === listener;
          });
...
var ModelUtils = /*#__PURE__*/function () {
  ...
  ModelUtils.getPointsFromDims = function getPointsFromDims(dims) {
    ...
    var transform = _.reverse([].concat(dims.transform));
...
function computeOrientationWithDelta(layout, delta, handle) {
  ...
  var deltaX = !_.isNil(delta.x) ? delta.x : 0;
  var deltaY = !_.isNil(delta.y) ? delta.y : 0;
...
function computeOrientationWithDeltaMultiple(orientation, delta, handle, boundaryBox, points) {
  ...
  if (handle.indexOf('C') !== -1) {
    ...
    _.map(newPoints, function (point, index) {
      var pointXDiff = 0;
      var pointYDiff = 0;
...
function computeOrientationWithDeltaARMultiple(orientation, deltaInp, handle, boundaryBox, points) {
  ...
  var height = orientation.height;
  var rotation = orientation.rotation;
  var deltaX = !_.isNil(deltaInp.x) ? deltaInp.x : 0;
  var deltaY = !_.isNil(deltaInp.y) ? deltaInp.y : 0;
...
function computeOrientationWithDeltaAlt(orientation, delta, handle) {
  ...
  var height = orientation.height;
  var deltaX = !_.isNil(delta.x) ? delta.x : 0;
  var deltaY = !_.isNil(delta.y) ? delta.y : 0; // let aspectRatio = width / height;
...
function getGradientString(gradient, palette) {
  ...
  if (palette) {
    _.forEach(palette, function (data, index) {
      colors.push(data.color);
    });
  } else {
    _.forEach(gradient.stops, function (data, index) {
...
var KeyValueContainer = /*#__PURE__*/function (_Model) {
    ...
    if (typeof key == 'object') {
      for (var prop in key) {
        if (this.isValidKey(prop)) {
          _.set(this.data, prop, key[prop]); // this.data[prop] = (key as any)[prop];
      ...
      if (this.isValidKey(key)) {
        _.set(this.data, key, value); // this.data[key] = value;
  ...
  _proto.remove = function remove(key) {
    if (typeof key === 'string' && !_.isNil(this.data[key])) {
...
var GlobalLayerUpdateController = /*#__PURE__*/function () {
  function GlobalLayerUpdateController() {
    ...
    this.shouldAddToBatch = function () {
      return _.last(_this.shouldBatch);
    };
...
var Layer = /*#__PURE__*/function (_Model) {
  ...
  function Layer(canvas) {
            ...
            if (dom) {
              ...
              _.forEach(style, function (value, key) {
                if (attributes.indexOf(key) !== -1) {
                  ...
                  var transform = _.get(value, '0.rotate');
    ...
    var config = yogax.yoga.Config.create();
    config.setPointScaleFactor(0);
    _this._yogaNode = yogax.yoga.Node.create(config);
  ...
  _proto.getDomBoundingBox = function getDomBoundingBox(dom, rotation) {
    ...
    if (dom) {
      ...
      if (_.isNil(left) || _.isNil(top) || _.isNil(width) || _.isNil(height)) {
  ...
  _proto.getBorderLeft = function getBorderLeft() {
    return this.yogaNode.getComputedBorder(yogax.yoga.EDGE_LEFT);
  };

  _proto.getBorderTop = function getBorderTop() {
    return this.yogaNode.getComputedBorder(yogax.yoga.EDGE_TOP);
  } // DOC: Layer ops
  ;
  ...
  _proto.calculateLayout = function calculateLayout() {
    ...
    if (rootLayer && rootLayer.yogaNode) {
      rootLayer.yogaNode.calculateLayout(yogax.yoga.UNDEFINED, yogax.yoga.UNDEFINED, yogax.yoga.DIRECTION_LTR);
    } else {
      this.yogaNode.calculateLayout(yogax.yoga.UNDEFINED, yogax.yoga.UNDEFINED, yogax.yoga.DIRECTION_LTR);
    }
  ...
  _proto.isAutoWidth = function isAutoWidth() {
    ...
    if (position === 'absolute') {
      ...
      if (flexDirection === 'row') {
        ...
        if ((_.isNil(_flex) || isNaN(_flex)) && alignSelf !== 'stretch') {
          return true;
        } else {
          return false;
        }
  ...
  _proto.isAutoHeight = function isAutoHeight() {
    ...
    if (position === 'absolute') {
      ...
      if (flexDirection !== 'row') {
        ...
        if ((_.isNil(_flex2) || isNaN(_flex2)) && alignSelf !== 'stretch') {
          return true;
        } else {
          return false;
        }
  ...
  _proto.getTransform = function getTransform() {
    ...
    if (parent.getTransform && _.isArray(parent.getTransform())) {
  ...
  _proto.getPartialPath = function getPartialPath(node) {
    ...
    if (node.parent && node.parent.children) {
      ...
      var childIndex = _.findIndex(parentChildren, function (child) {
        if (child) {
          return node === child;
        }
  ...
  _proto.getHitRectResult = function getHitRectResult(x, y, width, height) {
    ...
    layersHit = _.orderBy(layersHit, [function (layer) {
      return layer.getDepth();
    }, function (layer) {
      return layer.getIndexInParent();
    }], ['desc', 'desc']);
    _.remove(layersHit, function (layer) {
  ...
  _proto.convertLayerDimensions = function convertLayerDimensions(dims) {
    ...
    if (!_.isNil(newLeft) && !_.isNil(dims.x)) {
      layoutData.left = newLeft;
    }

    if (!_.isNil(newRight) && !_.isNil(dims.x)) {
      layoutData.right = newRight;
    }

    if (_.isNil(newLeft) && _.isNil(newRight) && position === 'absolute' && !_.isNil(dims.x)) {
      layoutData.left = dims.x;
    }

    if (!_.isNil(newWidth) && !_.isNil(dims.width)) {
    ...
    if (!_.isNil(newTop) && !_.isNil(dims.y)) {
      layoutData.top = newTop;
    }

    if (!_.isNil(newBottom) && !_.isNil(dims.y)) {
      layoutData.bottom = newBottom;
    }

    if (_.isNil(newTop) && _.isNil(newBottom) && position === 'absolute' && !_.isNil(dims.y)) {
      layoutData.top = dims.y;
    }

    if (!_.isNil(newHeight) && !_.isNil(dims.height)) {
    ...
    if (!_.isNil(newLeft) && !_.isNil(newRight) && position === 'absolute' && !_.isNil(newWidth)) {
      delete layoutData.right;
    }

    if (!_.isNil(newTop) && !_.isNil(newBottom) && position === 'absolute' && !_.isNil(newHeight)) {
  ...
  _createClass(Layer, [{
    ...
    get: function get() {
      ...
      if (parent) {
        var parentX = !_.isNil(parent.rootX) ? parent.rootX : parent._dims.x;
    ...
    get: function get() {
      ...
      if (parent) {
        var parentY = !_.isNil(parent.rootY) ? parent.rootY : parent._dims.y;
    ...
    get: function get() {
      ...
      if (styleObj.transform) {
        var transformValue = _.isArray(styleObj.transform) ? styleObj.transform : styleObj.transform['value'];
        var index = _.findIndex(transformValue, function (item) {
          var rotate = _.keys(item).indexOf('rotate');
          return rotate !== -1 && !_.isNil(item['rotate']);
        });
...
var Canvas = /*#__PURE__*/function (_Layer) {
  ...
  function Canvas(dom) {
    ...
    _this.setCollisionScope(new detectCollisions.Collisions());

    _this._hoveredLayers = [];
    _this._selectedLayers = [];
    _this._stackWorldDOM = [];
    _this._stackViewportDOM = [];
    ReactDOM.render(React.createElement(DesignerReact, {
  ...
  _proto.convertPointFromPageToViewport = function convertPointFromPageToViewport(x, y) {
    ...
    var viewportDom = ReactDOM.findDOMNode(this._viewportRef);
    var offsetLeft = 0;
    var offsetTop = 0;
  ...
  _proto.getBoundingBox = function getBoundingBox(layers, withoutRotation, wrtParent) {
    ...
    if (_.isEmpty(layers)) {
      ...
      var minXLayer = _.minBy(layerPoints, function (layer) {
        return layer[0];
      });
      var minYLayer = _.minBy(layerPoints, function (layer) {
        return layer[1];
      });
      var maxXLayer = _.maxBy(layerPoints, function (layer) {
        return layer[0];
      });
      var maxYLayer = _.maxBy(layerPoints, function (layer) {
        return layer[1];
      });
  ...
  function Gradient(gradientType, from, to, stops, activeIndex, elipseLength) {
    ...
    this.getGradientString = function (palette) {
      ...
      if (palette) {
        ...
        _.forEach(_this.stops, function (data, index) {
          colors.push(data.stopColor);
        });
      }
...
var ViewRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    var domNode = reactNativeWeb.findNodeHandle(this._ref);
  ...
  _proto.render = function render() {
    ...
    return React.createElement(reactNativeWeb.View, Object.assign({
      ...
      return React.createElement(RootRenderer, Object.assign({}, _this2.props, {
        key: child.id,
        layer: child
      }));
    }));
...
var TextRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(reactNativeWeb.Text, Object.assign({
      webkit: "true"
    }, layerProps, {
      style: _extends({
        fontSize: 14,
...
var TextInputRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var filteredProps = _.pick(layerProps, ['defaultValue', 'numberOfLines', 'multiline', 'maxLength', 'placeholder', 'placeholderTextColor', 'value']);
    var layerId = layerProps['id'];
    delete layerProps['id'];
    return React.createElement(reactNativeWeb.TextInput, Object.assign({
      ref: function ref(c) {
        _this2._ref = c;
      }
    }, filteredProps, {
...
var ImageRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var sourceUri = _.get(layerProps, 'source.uri', undefined);
    ...
    if (this.maskPath) {
      ...
      return React.createElement(Svg__default // @ts-ignore
      , {
        // @ts-ignore
        id: layerId,
        style: imageStyle,
      ...
      }, React.createElement(Svg.Defs, null, React.createElement(Svg.Mask, {
        id: imageMaskId,
        x: "0",
        y: "0"
    ...
    return React.createElement(reactNativeWeb.Image, Object.assign({}, layerProps, {
      style: imageStyle,
      source: {
        uri: imageURI
      },
  ...
  _createClass(ImageRenderer, [{
    ...
    get: function get() {
      ...
      return conversions.generateSVGPath(imageMask || [], 1, true, layer.props.get('viewBox'));
    }
  }]);
...
var PathRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    , {
      ...
      viewBox: layerProps.viewBox,
      preserveAspectRatio: "none"
    }, !_.isEmpty(gradient) || mask && !_.isEmpty(mask) ? React.createElement(Svg.Defs, null, mask && !_.isEmpty(mask) && React.createElement(Svg.Mask, {
      id: maskId,
      x: "0",
      y: "0"
    }, React.createElement(Svg.Path, {
      ...
      ,
      d: this.maskPath
    })), !_.isEmpty(gradient) && React.createElement(Svg.LinearGradient, {
      id: gradientId,
      x1: gradient.from.x,
      y1: gradient.from.y,
      x2: gradient.to.x,
      ...
      return React.createElement(Svg.Stop, {
        key: "gradient-" + gradient.id + "-stop-" + index,
        offset: stop.offset,
        stopColor: stop.stopColor
      });
    }))) : null, React.createElement(Svg.Path, {
      stroke: layerProps.stroke,
      // transform={layerProps.rotation ? transform : undefined}
      fill: !_.isEmpty(gradient) ? "url(#" + gradientId + ")" : layerProps.fill,
      ...
      mask: mask && !_.isEmpty(mask) ? "url(#" + maskId + ")" : undefined
    }));
  };
  ...
  _createClass(PathRenderer, [{
    ...
    get: function get() {
      ...
      return conversions.generateSVGPath(pathProps.points, pathProps.strokeWidth, pathProps.isClosed, pathProps.viewBox);
    }
  }, {
    key: "maskPath",
    get: function get() {
...
var AndroidSwitchRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var layerId = layerProps['id'];
    delete layerProps['id'];
    return React.createElement(reactNativeWeb.Switch, Object.assign({
      ref: function ref(c) {
        _this2._ref = c;
      }
    }, layerProps, {
...
var IOSSwitch = /*#__PURE__*/styled__default.input( /*#__PURE__*/_templateObject(), function (props) {
...
var IOSSwitchRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var layerId = layerProps['id'];
    delete layerProps['id'];
    return React.createElement(IOSSwitch, Object.assign({
      ref: function ref(c) {
        _this2._ref = c;
      },
      type: "checkbox"
...
var SwitchRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return platform === 'Android' ? React.createElement(AndroidSwitchRenderer, Object.assign({}, this.props)) : React.createElement(IOSSwitchRenderer, Object.assign({}, this.props));
  };
...
var AndroidActivityIndicatorRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(reactNativeWeb.ActivityIndicator, Object.assign({
      ref: function ref(c) {
        _this2._ref = c;
      }
    }, layerProps, {
...
var keyFrameFade = /*#__PURE__*/styled.keyframes( /*#__PURE__*/_templateObject$1());
var Bar = /*#__PURE__*/styled__default.div( /*#__PURE__*/_templateObject2(), keyFrameFade, function (props) {
  return props.color ? props.color : defaultSpinnerColor;
});
var SpinnerWrapper = /*#__PURE__*/styled__default.div( /*#__PURE__*/_templateObject3());
var IOSSpinner = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var size = props.size,
      color = props.color,
  ...
  return React.createElement(SpinnerWrapper, Object.assign({
    ref: ref,
    style: {
      height: height,
      width: width
    }
  }, remainingProps), React.createElement(Bar, {
    color: color,
    style: {
...
var IOSActivityIndicatorRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var height = layerProps.size === 'large' ? 40 : 22;
    var width = layerProps.size === 'large' ? 39 : 22;
    return React.createElement(IOSSpinner, Object.assign({
      ref: function ref(c) {
        _this2._ref = c;
      }
    }, layerProps, {
...
var ActivityIndicatorRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return platform === 'Android' ? React.createElement(AndroidActivityIndicatorRenderer, Object.assign({}, this.props)) : React.createElement(IOSActivityIndicatorRenderer, Object.assign({}, this.props));
  };
...
var EllipseRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var strokeWidth = Number(get(ellipseProps, 'strokeWidth', 0));
    var appliedProps = {
      cx: ellipseProps.cx,
      cy: ellipseProps.cy,
      rx: ellipseProps.rx,
    ...
    return React.createElement(Svg__default, {
      ...
      preserveAspectRatio: "none"
    }, React.createElement(Svg.Ellipse, Object.assign({}, appliedProps)));
  };
...
var SliderWrapper = /*#__PURE__*/styled__default.div( /*#__PURE__*/_templateObject$2());
var AndroidSliderButton = /*#__PURE__*/styled__default.div( /*#__PURE__*/_templateObject2$1(), function (props) {
...
var AndroidSliderProgressBar = /*#__PURE__*/styled__default.div( /*#__PURE__*/_templateObject3$1(), function (props) {
  var value = props.value,
...
var IOSSliderButton = /*#__PURE__*/styled__default.div( /*#__PURE__*/_templateObject4(), function (props) {
  var value = props.value;
  return value ? value + "px" : '0px';
});
var IOSSliderProgressBar = /*#__PURE__*/styled__default.div( /*#__PURE__*/_templateObject5(), function (props) {
  var value = props.value,
      minimumTrackTintColor = props.minimumTrackTintColor,
      maximumTrackTintColor = props.maximumTrackTintColor;
...
var Slider = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    var value = _.isNil(this.props.value) ? 0 : this.props.value;
    var maximumValue = _.isNil(this.props.maximumValue) ? 100 : this.props.maximumValue;
    ...
    }, React.createElement(SliderProgressBar, {
      style: {
        width: '100%',
        height: 2,
...
var MapViewRenderer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    try {
      return React.createElement(reactNativeWeb.Image, Object.assign({
        ref: function ref(c) {
          _this2._ref = c;
        }
      }, layerProps, {
...
var PopoverMenuPlugin = /*#__PURE__*/function () {
  ...
  _proto.showMenu = function showMenu(context, json, event) {
    ...
    var menuReactElement = React.createElement(builderxModuleContextMenu.MainMenu, {
      menuId: "menuId-" + randomId,
      data: json
    });
    ReactDOM__default.render(menuReactElement, this.containerElement);
    builderxModuleContextMenu.contextMenu.show({
      id: "menuId-" + randomId,
...
function getAllSiblingLayerPoints(config, context, layers, parent) {
  ...
  if (parent) {
    _.forEach(parent.children, function (layer) {
      try {
...
function addToSnapXPoint(snapXPoints, value, rootValue, min, max, distance) {
  if (!_.find(snapXPoints, function (val) {
...
function addToSnapYPoint(snapYPoints, value, rootValue, min, max, distance) {
  if (!_.find(snapYPoints, function (val) {
    return val.value === value && val.rootValue === rootValue && val.minY === min && val.maxY === max;
  })) {
    snapYPoints.push({
      value: value,
...
function snapPoint(context, snapPoints, startPoint, totalDelta, dims, absoluteDelta, startAbsolutePoint, parentAbsoluteRotation, boundingBoxWRTWorld, handle) {
  ...
  var minSnappedDataX = _.minBy([rulersDataX, gridDataX, siblingDataX, parentSnappedDataX], function (data) {
  ...
  var minSnappedDataY = _.minBy([rulersDataY, gridDataY, siblingDataY, parentSnappedDataY], function (data) {
...
function getSnapPoints(config, context, selectedLayers, parent, handle) {
  ...
  if (config.rulerSnap) {
    ...
    _.forEach(rulerSnapPoints.x, function (coordinate, index) {
    ...
    _.forEach(rulerSnapPoints.y, function (coordinate, index) {
...
function isContained(axis, box, helperBox) {
  if (axis === 'x') {
    ...
    var rightContained = _.round(box.x + box.width, 2) >= _.round(helperBox.x + helperBox.width, 2);
  ...
  if (axis === 'y') {
    ...
    var bottomContained = _.round(box.y + box.height, 2) >= _.round(helperBox.y + helperBox.height, 2);
  ...
  _proto.display = function display() {
    if (this.show) {
      ...
      if (hoveredLayers.length) {
        ...
        parentHoveredLayer = _.get(hoveredLayers, '[0].parent');
      }
      ...
      if (this.canvas.selectedLayers.length && hoveredDims) {
        ...
        helperBox = this.canvas.getBoundingBox(this.canvas.selectedLayers);
        var parent = _.get(this.canvas, 'selectedLayers[0].parent');
...
var TextEditor = /*#__PURE__*/function (_React$Component) {
  ...
  function TextEditor(props) {
    ...
    _this.isAuto = _this.props.layer && _this.props.layer.layout && _.isNil(_this.props.layer.layout.get('width'));
    ...
    _this.handleTab = function (event) {
      ...
      var newContentState = draftJs.Modifier.replaceText(_this.state.editorState.getCurrentContent(), _this.state.editorState.getSelection(), '\t');
      var editorState = draftJs.EditorState.push(_this.state.editorState, newContentState, 'insert-characters');
    ...
    _this.state = {
      editorState: draftJs.EditorState.moveFocusToEnd(draftJs.EditorState.createWithContent(draftJs.ContentState.createFromText(_this.text || '')))
    };
    return _this;
  }
...
var TextEditorPlugin = /*#__PURE__*/function () {
  ...
  _proto.mountTextEditor = function mountTextEditor(context, layer) {
    ...
    if (layer && (layer.type == 'text' || layer.type == 'textInput')) {
      ...
      ReactDOM__default.render(React.createElement(TextEditor, {
        layer: layer,
...
var PathEditor = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function PathEditor() {
    ...
    _this.emitUpdatedJSON = function () {
      if (_this.path) {
        if (_this.props.newPath) {
          ...
          var convertedJSON = conversions.convertPaperPointToBxObj(tempPath);
          ...
          var _convertedJSON = conversions.convertPaperPointToBxObj(_tempPath);
    ...
    _this.onMouseUp = function (event) {
      ...
      if (_this.props.newPath && _this.path) {
        ...
        if (hitResult && hitResult.segment && hitResult.segment.index === 0 && hitResult.segment.next || _.get(event, 'event.detail') === 2) {
          _this.closePath();
  ...
  _proto.init = function init() {
    ...
    if (newPath) {
      ...
      var pathJSON = conversions.getPaperPathFromPoints(points, isClosed);
      path = pathJSON;
...
var PathEditorPlugin = /*#__PURE__*/function () {
  function PathEditorPlugin() {
    ...
    this.handleEvent = function (data) {
      ...
      ReactDOM__default.render(React.createElement(PathEditor, {
...
var GradientEditorRenderer = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var dims = props.dims,
        zoom = props.zoom,
        scroll = props.scroll;
    return React.createElement(LineSegmentSliderInput //@ts-ignore
    , {
      //@ts-ignore
      x: dims.rootX,
      y: dims.rootY,
...
var GradientEditorPlugin = /*#__PURE__*/function () {
  function GradientEditorPlugin() {
    ...
    this.render = function (layer) {
      ...
      ReactDOM__default.render(React.createElement(GradientEditorRenderer, {
        layer: layer,
        dims: dims,
        zoom: _this.canvas.getZoom(),
        scroll: scroll,
...
var StageDesigner = /*#__PURE__*/function () {
  function StageDesigner() {
    ...
    this.getNewRootLayer = function (targetDims, currentArtboard) {
      ...
      var newRootLayersHit = _.filter(layersHit, function (layer) {
    ...
    this.handleMoveLayerArtboard = function (event) {
      if (_.indexOf(_this.previousMovedLayers, event.target) !== -1) {
        return;
      }
      ...
      var currentSelectedLayers = _.filter(_this.canvas.selectedLayers, function (layer) {
    ...
    this.moveLayer = function (layer, newRootLayer) {
      ...
      var fromIndex = _.indexOf((_layer$parent = layer.parent) == null ? void 0 : _layer$parent.children, layer);
      ...
      if (newLayer) {
        _.forEach(newLayer.convertLayerDimensions(newLayerDims), function (value, key) {
          _this.canvas.dispatchEvent('setStyleAttribute', new CommandEvent('setStyleAttribute', _this.canvas, {
            layer: newLayer,
            key: key,
            value: value,
  ...
  _proto.activate = function activate() {
    ...
    this.canvas.addMiddleware('MouseRect.getHitRectResult', function (next, hitRectResult) {
      ...
      if (selectedArtboard) {
        ...
        var hitRectResultWithIgnored = _.union(hitRectResult, ignoredHitRectLayers);
        hitRectResultWithIgnored.forEach(function (layer) {
          ...
          if (currentLayerArtboard.children[0] && currentLayerArtboard.children[0].children.includes(layer)) {
            if (layer.style.get('pointerEvents') !== 'none') {
              ...
              modLayers = _.intersection(hitRectResult, layer.children);
            }
          }
          ...
          if (modLayers) {
            ...
            currentLayerArtboard === selectedArtboard) {
              selectedArtboardLayers = _.union(selectedArtboardLayers, modLayers);
            } // Check if layer belongs to lowestIndexArtboard
            else {
                var index = _.indexOf(allArtboards, currentLayerArtboard);

                if (index < lowestIndex) {
                  // If index is lesser than previous, createNewArray and change index
                  lowestIndexArtboardLayers = [];
                  lowestIndexArtboardLayers = _.union(lowestIndexArtboardLayers, modLayers);
                  lowestIndex = index;
    ...
    this.canvas.addMiddleware("LayerResizer.getHandles", function (next, layers) {
      ...
      if ((layers == null ? void 0 : (_layers$ = layers[0]) == null ? void 0 : (_layers$$parent = _layers$.parent) == null ? void 0 : _layers$$parent.type) === 'canvas') {
        ...
        var handlesWithoutRotation = _.filter(handles, function (h) {
          return h !== 'ROTATE';
        });
  ...
  _proto.getHitArtboard = function getHitArtboard(context, x, y) {
    ...
    var artboards = [];
    _.forEach(hitLayers.reverse(), function (layer) {
      if (artboardArray.includes(layer)) {
        artboards.push(layer);
      }
    });

    if (_.isEmpty(artboards)) {
      return null;
    }
  ...
  _proto.modifyEventForSelectableLayers = function modifyEventForSelectableLayers(event, forLayerDrag) {
    ...
    var _loop = function _loop() {
      ...
      if (_.union(ancestorsList, ancestorSiblingsList).includes(currentLayer)) {
...
function filterIgnoredLayers(currentLayer, hitLayers) {
  if (hitLayers.includes(currentLayer)) {
    ...
    var topChildInHitLayers = _.findLast(currentLayer.children, function (child) {
...
var FlexDragPlugin = /*#__PURE__*/function () {
  function FlexDragPlugin() {
    ...
    this.saveSiblingOpacity = function (parentLayer) {
      _.forEach(parentLayer.children, function (layer) {
        if (layer.isFlexChild()) {
          var opacity = !_.isNil(layer.style.get('opacity')) ? layer.style.get('opacity') : 1;
    ...
    */
    ...
    this.recordCurrentSnapshot = function (parent) {
      ...
      parent.children.forEach(function (child, index) {
        if (child !== _this.ghostLayer) _this.currentSnapshotData.set(child, {
          index: index,
          dims: _.cloneDeep(_this.getMarginAdjustedBounds(child))
        });
      });
    };
    ...
    this.revertBackToSnapshot = function (parent, snapshotData) {
      snapshotData.forEach(function (value, layer) {
        ...
        if (_this.flexLayers.includes(layer) && originalHW) {
          if (!originalHW.height && !_.isNil(layer.layout.get('height'))) layer.removeLayout('height');
          if (!originalHW.width && !_.isNil(layer.layout.get('width'))) layer.removeLayout('width');
        }
      });
    };
    ...
    this.findAbsolutePreviousLayer = function (index) {
      ...
      while (_.isNil(previousLayer) && prevLayerIndex >= 0) {
    ...
    this.findAbsoluteNextLayer = function (index) {
      ...
      while (_.isNil(nextLayer) && nextLayerIndex < _this.flexLayers.length) {
    ...
    this.setTriggerPoints = function () {
      ...
      if (_this.target instanceof Layer) {
        var targetIndexInParent = _.indexOf(_this.flexLayers, _this.target);
        ...
        var sortedSelectedLayers = _.sortBy(_this.target, function (layer) {
          return layer.getIndexInParent();
        });
        var firstSelectedLayerIndex = _.indexOf(_this.flexLayers, sortedSelectedLayers[0]);
        var lastSelectedLayerIndex = _.indexOf(_this.flexLayers, sortedSelectedLayers[sortedSelectedLayers.length - 1]);
    ...
    this.handleSwapWRTNewPosition = function (oldCenter, newCenter) {
      ...
      if (_this.target instanceof Layer) {
        targetLayerIndex = _.indexOf(_this.flexLayers, _this.target);
        ...
        if (toMoveLayer) _this.newTargetIndex = _.indexOf(_this.flexLayers, toMoveLayer);
      } else {
        var sortedSelectedLayers = _.sortBy(_this.target, function (layer) {
          return layer.getIndexInParent();
        });
      ...
      if (!_.isNil(newIndex) && newIndex >= 0 && toMoveLayer) {
    ...
    this.layerDragStart = function (next, event) {
      ...
      if (event.selectedLayers) {
        ...
        var parent = _.get(event.selectedLayers, '[0].parent');
    ...
    this.layerDragEnd = function (next, event) {
      ...
      if (_this.targetGhostLayer) {
        ...
        if (_this.target instanceof Layer) {
          ...
          if (!_.isNil(_this.newTargetIndex) && _this.target.getIndexInParent() !== _this.newTargetIndex) {
            _this.canvas.dispatchEvent('moveLayer', new CommandEvent('moveLayer', _this.canvas, {
          ...
          if (!_.isNil(_this.newTargetIndex) && sortedSelectedLayers[0].getIndexInParent() > _this.newTargetIndex) {
          ...
          if (!_.isNil(_this.newTargetIndex) && sortedSelectedLayers[0].getIndexInParent() !== _this.newTargetIndex) {
            sortedSelectedLayers.forEach(function (layer) {
              ...
              if (parent && !_.isNil(_this.newTargetIndex)) newToSelectLayers.push(parent.children[_this.newTargetIndex]);
            });
          }
...
var RulerScaleWrapper = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", null, React.createElement("div", {
    ...
    }, React.createElement(HorizontalRuler, Object.assign({
      ...
      onContextMenu: this.props.onContextMenu
    }, React.createElement(VerticalRuler, Object.assign({
...
var RulerScalePlugin = /*#__PURE__*/function () {
  ...
  _proto.renderScale = function renderScale() {
    ...
    ReactDOM__default.render(React.createElement(RulerScaleWrapper, {
      canvas: this.canvas,
  ...
  function RulerLinesPlugin() {
    ...
    this.addLine = function (context, axis, axisCoordinate, noEmit) {
      ...
      _this.canvas.addEventListener('LineDrawer.dragStart', function (data) {
        ...
        var index = _.findIndex(_this.lines, function (o) {
          return o.dom == target;
        });
...
function drawLinesForSnap(canvas, layer, boundingBox, meta, className) {
  ...
  if (!isNaN(_.get(meta, 'snappedSide.x.snappedSide.snappedPoint.rootValue', NaN))) {
  ...
  if (!isNaN(_.get(meta, 'snappedSide.y.snappedSide.snappedPoint.rootValue', NaN))) {
...
var StageDesignerPreviewModePlugin = /*#__PURE__*/function () {
  ...
  _proto.stageMode = function stageMode(context) {
    ...
    _.map(this.artboards, function (artboard) {
      artboard.show();
  ...
  _proto.nextArtboard = function nextArtboard() {
    ...
    if (selectedArtboard) selectedArtboardIndex = _.indexOf(this.artboards, selectedArtboard);
  ...
  _proto.setDisplayForButtons = function setDisplayForButtons() {
    ...
    if (selectedArtboard) {
      var selectedArtboardIndex = _.indexOf(this.artboards, selectedArtboard);
  ...
  _proto.handleSelectedArtboardChange = function handleSelectedArtboardChange() {
    ...
    _.map(this.artboards, function (artboard) {
      if (!_.isEqual(artboard, selectedArtboard)) {
        artboard.hide();
...
var StageDesignerDropPlugin = /*#__PURE__*/function () {
  ...
  _proto.activate = function activate() {
    ...
    this.canvas.addEventListener('drop', function (e) {
      ...
      var artboard = null;
      _.map(hitResult, function (hitLayer) {
...
var StageDesignerDrawComponent = /*#__PURE__*/function () {
  function StageDesignerDrawComponent() {
    ...
    this.getDimsFromArtboard = function (layerPoints) {
      var relativeX = 0;
      var relativeY = 0;
      var layerX = _.get(layerPoints, 'worldX', undefined);
      var layerY = _.get(layerPoints, 'worldY', undefined);
      var height = _.get(layerPoints, 'height', undefined);
      var width = _.get(layerPoints, 'width', undefined);
...
var StageDesignerRulerPlugin = /*#__PURE__*/function () {
  function StageDesignerRulerPlugin() {
    ...
    this.getLineCoordinates = function () {
      ...
      _.forEach(rulerLines, function (line) {
        if (line.axis === 'y') {
          coordinates.y.push(line.axisCoordinate);
        } else {
          coordinates.x.push(line.axisCoordinate);
    ...
    this.render = function (layer) {
      ...
      if (deviceFrame.deviceName) {
        switch (deviceFrame.deviceName.toLowerCase()) {
          ...
          case 'iphone xs':
          case 'iphone 11 pro':
            FrameComponent = React.createElement(IPhoneXFrame, {
          ...
          case 'iphone 11':
            FrameComponent = React.createElement(IPhoneXsMaxFrame, {
              deviceOrientation: deviceFrame.deviceOrientation,
              left: 0,
              top: 0
            });
...
var AndroidStatusBar = (function (props) {
  ...
  }, React.createElement(BatterySection, {
    width: props.width,
    // backgroundColor={backgroundColor}
    left: 0
  }), React.createElement(NetworkSection, {
    width: props.width,
    color: color,
...
var LeftSection = /*#__PURE__*/function (_React$Component2) {
  ...
  _proto2.render = function render() {
    return React.createElement("div", {
      ...
      x: 0,
      y: 13
    }, "9:41 AM")), React.createElement("path", {
...
var NetworkSection$1 = /*#__PURE__*/function (_React$Component2) {
  ...
  _proto2.render = function render() {
    return React.createElement("div", {
      ...
      x: 38,
      y: "11.5"
    }, "Carrier")), React.createElement("path", {
...
var IOSStatusBar = (function (props) {
  ...
  }, React.createElement(BackgroundRect, {
    backgroundColor: props.backgroundColor,
    width: props.width
  }), React.createElement(NetworkSection$1, {
    left: 3,
    color: props.color
  }), React.createElement(TimeSection, {
    color: props.color,
    left: props.width / 2 - 20
  }), React.createElement(BatterySection$1, {
    color: props.color,
    left: props.width - 65
  }));
});
...
var StatusBarComponent = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.getElement = function getElement() {
    ...
    if (IOS && !IPHONEX_OR_IPHONEXS && !IPHONEXR_OR_IPHONEXSMAX) {
      ...
      }, React.createElement(IPhoneXStatusBar, {
        width: deviceWidth,
        deviceOrientation: deviceOrientation,
      ...
      }, React.createElement(AndroidStatusBar, {
        width: deviceWidth,
        height: deviceHeight,
...
var StatusBar = /*#__PURE__*/function () {
  function StatusBar() {
    ...
    this.render = function (layer) {
      ...
      ReactDOM__default.render(React.createElement(StatusBarComponent, {
        layer: layer,
        width: layer.getBoundingClientRect().width,
        height: layer.getBoundingClientRect().height,
...
var ResizerRendererPlugin = /*#__PURE__*/function () {
  ...
  _proto.setHandleStyle = function setHandleStyle(handleInstance, handleName) {
    ...
    _.forEach(propsWithoutPx, function (val, key) {
      handleInstance.handleLayer.style[key] = val;
    });
    _.forEach(_extends({}, fixedLayoutProps, pos), function (val, key) {
    ...
    if (handleName !== 'ROTATE') {
      ...
      pos = rotatorPos;
      _.forEach(rotatorPropsWithoutPx, function (val, key) {
...
var LayerResizerPlugin = /*#__PURE__*/function () {
  function LayerResizerPlugin() {
    ...
    this.getHandles = function (layers) {
      return _this.canvas.executeMiddleware('LayerResizer.getHandles', layers, function (layers) {
        ...
        layers.forEach(function (layer) {
          var isLayerAbsolute = !_.isNil(layer.layout.get('position'));
          ...
          if (layer.type === 'icon' || layer.type === 'switch' || layer.type === 'activityIndicator' || isAutoHeight && isAutoWidth) {
            handles = _.intersection(handles, ['ROTATE']);
          }

          var handlesForAutoOrAbs = _this.getHandlesForAutoOrAbsoluteLayer(isAutoHeight, isAutoWidth);

          if (isLayerAbsolute) {
            handles = _.intersection(handles, handlesForAutoOrAbs);
          } else {
            var handlesForFill = _this.getHandlesForFill(layer);

            var handlesHere = _.intersection(handlesForAutoOrAbs, handlesForFill);
            handles = _.intersection(handles, handlesHere);
          }
        });
        return handles;
      });
  ...
  _proto.normalizeChildrenFlex = function normalizeChildrenFlex() {
    ...
    if (parent) {
      ...
      parent.children.forEach(function (child, index) {
        ...
        if (!_.isNil(layerFlex) && !_.isNil(totalChildrenFlex)) {
  ...
  _proto.activate = function activate() {
    ...
    this.canvas.on('selectedLayers', function (event) {
      ...
      if (_.isEmpty(_this6.canvas.selectedLayers)) {
    ...
    this.canvas.addEventListener('ResizerRenderer.dragStart', function (data) {
      _this6.canvas.executeMiddleware('LayerResizer.dragStart', {
        ...
        _.forEach(_this6.selectedLayers, function (selectedLayer) {
...
exports.ActivityIndicatorRendererPlugin = ActivityIndicatorRendererPlugin;
exports.ArtboardEvent = ArtboardEvent;
exports.Canvas = Canvas;
exports.ConstructionLinesPlugin = ConstructionLinesPlugin;
exports.DataStorePlugin = DataStore;
exports.DesignerKeyboardEvent = DesignerKeyboardEvent;
exports.DeviceFrame = DeviceFrame;
exports.DragPlugin = Drag;
exports.DrawComponent = DrawComponent;
exports.EllipseRendererPlugin = EllipseRendererPlugin;
exports.Event = Event;
exports.FlexDragPlugin = FlexDragPlugin;
exports.FloatingButtonPlugin = FloatingButton;
exports.FontResizerEvent = FontResizerEvent;
exports.FontResizerPlugin = FontResizerPlugin;
exports.Gradient = Gradient;
exports.GradientEditorEvent = GradientEditorEvent;
exports.GradientEditorPlugin = GradientEditorPlugin;
exports.GridRendererPlugin = GridRenderer;
exports.HoverPlugin = HoverPlugin;
exports.HtmlDragToWorldPlugin = HtmlDragToWorldPlugin;
exports.IconFonts = Fonts;
exports.IconRendererPlugin = IconRendererPlugin;
exports.ImageRendererPlugin = ImageRendererPlugin;
exports.KeyValueContainer = KeyValueContainer;
exports.Layer = Layer;
exports.LayerDragPlugin = LayerDrag;
exports.LayerLabel = LayerLabel;
exports.LayerMouseCursor = LayerMouseCursorPlugin;
exports.LayerResizerEvent = LayerResizerEvent;
exports.LayerResizerPlugin = LayerResizerPlugin;
exports.LineDrawerPlugin = LineDrawer;
exports.MapViewRendererPlugin = MapViewRendererPlugin;
exports.MeasurementLinesPlugin = MeasurementLinesPlugin;
exports.ModelUtils = ModelUtils;
exports.MouseEvent = DesignerMouseEvent;
exports.MouseRectPlugin = MouseRectPlugin;
exports.NativeHtmlDragPlugin = NativeHtmlDrag;
exports.OpacityShortcutPlugin = OpacityShortcutPlugin;
exports.PathEditorPlugin = PathEditorPlugin;
exports.PathEvent = PathEvent;
exports.PathRendererPlugin = PathRendererPlugin;
exports.PlusButtonPlugin = PlusButton;
exports.PopoverMenuPlugin = PopoverMenuPlugin;
exports.ResizerRendererPlugin = ResizerRendererPlugin;
exports.RulerLinesPlugin = RulerLinesPlugin;
exports.RulerScalePlugin = RulerScalePlugin;
exports.ScrollMousePositionPlugin = ScrollMousePositionPlugin;
exports.ScrollViewRendererPlugin = ScrollViewRendererPlugin;
exports.SetScrollEvent = Event;
exports.SliderRendererPlugin = SliderRendererPlugin;
exports.SnapLinesPlugin = SnapLines;
exports.SnapPointsCalculatorPlugin = SnapPointsCalculator;
exports.StageDesignerDeviceDataPlugin = StageDesignerDeviceData;
exports.StageDesignerDrawComponent = StageDesignerDrawComponent;
exports.StageDesignerDropPlugin = StageDesignerDropPlugin;
exports.StageDesignerPlugin = StageDesigner;
exports.StageDesignerPreviewModePlugin = StageDesignerPreviewModePlugin;
exports.StageDesignerRulerPlugin = StageDesignerRulerPlugin;
exports.StatusBar = StatusBar;
exports.SwitchRendererPlugin = IOSSwitchRendererPlugin;
exports.TextEditorEvent = TextEditorEvent;
exports.TextEditorPlugin = TextEditorPlugin;
exports.TextInputRendererPlugin = TextInputRendererPlugin;
exports.TextRendererPlugin = TextRendererPlugin;
exports.TooltipPlugin = TooltipPlugin;
exports.TouchableOpacityRendererPlugin = TouchableOpacityRendererPlugin;
exports.UndoRedoPlugin = UndoRedoPlugin;
exports.ViewRendererPlugin = ViewRendererPlugin;
exports.computeDelta = computeDelta;
exports.computeOrientation = computeOrientation;
exports.computeOrientationWithDelta = computeOrientationWithDelta;
exports.computeOrientationWithDeltaAR = computeOrientationWithDeltaAR;
exports.computeOrientationWithDeltaARMultiple = computeOrientationWithDeltaARMultiple;
exports.computeOrientationWithDeltaAlt = computeOrientationWithDeltaAlt;
exports.computeOrientationWithDeltaAltMultiple = computeOrientationWithDeltaAltMultiple;
exports.computeOrientationWithDeltaMultiple = computeOrientationWithDeltaMultiple;
exports.computeOrientationWithDeltaShiftAlt = computeOrientationWithDeltaShiftAlt;
exports.computeOrientationWithDeltaShiftAltMultiple = computeOrientationWithDeltaShiftAltMultiple;
exports.designerAction = action;
exports.getBoundingBoxFromOrientation = getBoundingBoxFromOrientation;
exports.getCorrection = getCorrection;
exports.getNewLayout = getNewLayout;
exports.getResizerQuad = getResizerQuad;
exports.resumeLayoutUpdates = resumeLayoutUpdates;
exports.startChildrenLayoutUpdates = startChildrenLayoutUpdates;
exports.startRerender = startRerender;
exports.stopAndBatchLayoutUpdates = stopAndBatchLayoutUpdates;
exports.stopAndForgetLayoutUpdates = stopAndForgetLayoutUpdates;
exports.stopChildrenLayoutUpdates = stopChildrenLayoutUpdates;
exports.stopRerender = stopRerender;
//# sourceMappingURL=designer.cjs.development.js.map
