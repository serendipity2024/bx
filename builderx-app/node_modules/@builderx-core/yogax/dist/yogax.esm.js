import { isNil, isArray, pickBy, map, get } from 'lodash-es';
    ...
    if (typeof value !== 'string') {
      if (isArray(yogaEdge)) {
        ...
        if (yogaEdge === yoga.EDGE_ALL) {
          ...
          if (!isNil(yogaNode.props.style['borderLeftWidth']) || !isNil(yogaNode.props.style['borderHorizontalWidth'])) {
            edges.splice(edges.indexOf(yoga.EDGE_LEFT), 1);
          }

          if (!isNil(yogaNode.props.style['borderRightWidth']) || !isNil(yogaNode.props.style['borderHorizontalWidth'])) {
            edges.splice(edges.indexOf(yoga.EDGE_RIGHT), 1);
          }

          if (!isNil(yogaNode.props.style['borderTopWidth']) || !isNil(yogaNode.props.style['borderVerticalWidth'])) {
            edges.splice(edges.indexOf(yoga.EDGE_TOP), 1);
          }

          if (!isNil(yogaNode.props.style['borderBottomWidth']) || !isNil(yogaNode.props.style['borderVerticalWidth'])) {
...
function () {
  ...
  _proto.updateNode = function updateNode(style) {
    ...
    var nodeStyle = pickBy(style, function (value) {
      return !isNil(value) && value !== '';
    });
    map(nodeStyle, function (value, key) {
  ...
  _proto.isAutoWidth = function isAutoWidth() {
    ...
    var width = get(this.props, 'style.width');
  ...
  _proto.isAutoHeight = function isAutoHeight() {
    var position = this.getPositionType();
    var height = get(this.props, 'style.height');
...
export { iconToText, updateNodePositionalAttributes, yogax as yoga };
//# sourceMappingURL=yogax.esm.js.map
