...
export default class NodeStart extends React.PureComponent<{
  path: string;
  ...
  render() {
    const dividerPropsBefore = {
      style: { listStyleType: "none", color: "transparent", height: 5 },
      onDragEnter: (e: any) => {
        this.onDragOver(e);
      },
      "data-path": this.props.path,
      "data-position": "_before_" + this.props.path,
      "data-node-id": "",
      layer: this.props.layer
    };
    return this.props.renderDivider(dividerPropsBefore);
  }
}
