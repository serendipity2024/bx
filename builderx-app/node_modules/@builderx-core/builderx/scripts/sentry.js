...
const jsPath = path.resolve(__dirname, "..", "build/editor/static/js");
const cssPath = path.resolve(__dirname, "..", "build/editor/static/css");
const buildPath = path.resolve(__dirname, "..", "build/editor");
...
const uploadSourceMapsCmd = `sentry-cli releases -o geekyants -p ${project} files ${packageJson.version} upload-sourcemaps --rewrite  --url-prefix ~/editor/static/js/  ${jsPath}`;
