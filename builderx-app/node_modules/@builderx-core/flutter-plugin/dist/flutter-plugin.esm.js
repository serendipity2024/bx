import { generateSVGPath } from '@builderx-core/builderx';
...
function drawpath(prop) {
  ...
  if (isEmpty(prop)) {
    ...
    var points = generateSVGPath(prop.props.points, prop.props.strokeWidth, prop.props.isClosed);
...
export { FlutterCodeGen };
//# sourceMappingURL=flutter-plugin.esm.js.map
